  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <main role="main">
          <!-- Hero Section -->
          <section class="hero-section d-flex align-items-center justify-content-between px-3 py-1">
            <div class="hero-text">
              <h1> Nurturing <span class="text-green">Young Minds</span> for <br /> a <span
                  class="text-orange">Brighter</span> Tomorrow </h1>
              <p class="mt-3">
            ...
            <div class="hero-image">
              <xsl:element name="img">
                ...
                <xsl:attribute
                  name="class">img-fluid</xsl:attribute>
              </xsl:element>
            </div>
          </section>
          ...
          <section class="hero-section d-flex align-items-center justify-content-between px-5 py-5">
            ...
            <div class="hero-text">
              ...
              <xsl:element name="a">
                ...
                <xsl:attribute
                  name="class">btn btn-success</xsl:attribute>
                <xsl:value-of
                  select="$home/enrollment/enroll_button_text" />
              </xsl:element>
            </div>
          </section>
            ...
            <div class="hero-text">
              ...
              <xsl:element name="a">
                ...
                <xsl:attribute
                  name="class">btn btn-success</xsl:attribute>
                <xsl:value-of
                  select="$home/summer_class/inquire_button_text" />
              </xsl:element>
            </div>
            <div class="Summer">
              <xsl:element name="img">
