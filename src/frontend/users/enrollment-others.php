          ...
          <section class="fee-section">
            ...
            <div class="table-responsive">
              <table class="fee-table">
                ...
                <tbody>
                  <tr>
                    <td>Regular School Uniform (per set)</td>
                    <td>₱500</td>
                    <td>Includes top & bottom</td>
                  </tr>
                  <tr>
                    <td>PE Uniform (per set)</td>
                    <td>₱500</td>
                    <td>Includes shirt & jogging pants</td>
                  </tr>
                  <tr>
                    <td>School ID with Lanyard</td>
                    <td>₱150</td>
                  ...
                  <tr>
                    ...
                    <td>₱100</td>
                    <td>Updated yearly</td>
                  </tr>
                  <tr>
                    <td>Learning Journal/Diary</td>
                    <td>₱100</td>
                    <td>For Grades 1–6 only</td>
                  </tr>
                  <tr>
                    <td>Name Patch (set of 3)</td>
                    <td>₱50</td>
                    <td>Optional but recommended</td>
                  </tr>
                  <tr>
                    <td>School Bag (with logo)</td>
                    <td>₱600</td>
                    <td>Optional</td>
                  </tr>
                  <tr>
                    <td>Umbrella (school-branded)</td>
                    <td>₱300</td>
                    <td>Optional</td>
                  </tr>
                </tbody>
